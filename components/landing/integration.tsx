      ...
      <div className="container mx-auto px-6 max-w-7xl flex flex-col items-center relative z-10">
        ...
        <div className="mb-20 text-center space-y-4">
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border border-zinc-200 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm shadow-sm dark:border-zinc-800 cursor-pointer group transition-all mx-auto"
          >
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4 text-zinc-600 dark:text-zinc-400">
                ...
                <span className="break-all">
                  ...
                  https://zenblocks-three.vercel.app/r/utils.json
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-zinc-800 dark:text-zinc-300 pl-4 border-l-2 border-emerald-500/20">
                ...
                <span className="text-green-600 dark:text-green-400">
                  "@/components/zenblocks/image-gallery"
                </span>
                ;
                <br />
                <br />
