...
<Preview link="pressure-test">
  <div className="relative w-full h-[300px] overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center justify-center p-8 bg-white dark:bg-zinc-950">
      <PressureTest 
        text="ZENBLOCKS" 
