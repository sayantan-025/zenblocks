...
> **Note:** The CLI will install the component file, but it **does not** set up the global `ThemeProvider`. If you haven't set up `next-themes` yet, please follow **Step 2** from the Manual Installation below.
