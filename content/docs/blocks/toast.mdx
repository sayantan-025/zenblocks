...
<Preview link="toast">
  <div className="relative w-full h-[300px] flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
     <iframe src="/preview/toast" className="w-full h-full border-none" title="Toast Preview" />
  </div>
</Preview>
