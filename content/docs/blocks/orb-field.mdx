...
<Preview link="orb-field">
  <div className="relative w-full h-[500px] rounded-lg overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-background">
    <OrbField />
  </div>
</Preview>
...
3.  **Copy the Source Code**
    ...
    const DefaultOrbFieldConfig: PhysicsConfig = {
      count: 60,
      colors: [0x18181b, 0x71717a, 0xd4d4d8, 0xffffff],
