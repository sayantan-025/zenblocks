---
title: "Installation"
description: "Start building with ZenBlocks — a high-performance Component Build Registry for modern web applications."
icon: ListStart
---
...
**ZenBlocks** is a high-performance **Component Build Registry** featuring sophisticated, physics-enabled UI components designed to vary from utility-first primitives to complex, interactive blocks.
