...
> [!NOTE]
> During initialization, you can choose your preferred style, base color, and CSS variables. ZenBlocks will automatically adapt to your `components.json` configuration.
...
<Tabs items={["npx", "pnpm", "bun"]} id="tabs">
