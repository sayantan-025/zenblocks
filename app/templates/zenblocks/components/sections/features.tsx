...
const FeatureCard = ({ feature, index }: { feature: any; index: number }) => {
  ...
  const background = useTransform(
    [smoothX, smoothY],
    ([x, y]) =>
      `radial-gradient(300px circle at ${x}px ${y}px, var(--spotlight-color), transparent 80%)`,
  );
        ...
        <div className="flex flex-col items-center gap-20">
          ...
          <div className="flex flex-col items-center justify-center gap-6 text-center w-full">
            ...
            <p className="text-base text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-xl font-medium">
              Every component is engineered to handle edge cases, race
              conditions, and heavy animation loads without dropping a frame.
            </p>
          </div>
