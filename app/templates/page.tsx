...
const TEMPLATES: Template[] = [
  {
    id: "T001",
    slug: "zenblocks",
    name: "ZenBlocks — Landing Page Template",
    codename: "Premium Marketing Foundation — v1.0",
    description:
      "Deploy a high-conversion landing page with 8+ interactive sections and physics-driven UI components. Built with elite Next.js architecture.",
    price: 89,
    originalPrice: 120,
    badge: "Flagship",
    components: [
      { name: "Orb Field", color: "bg-violet-500" },
      { name: "Pressure Test", color: "bg-rose-500" },
      { name: "Logo Loop", color: "bg-cyan-500" },
      { name: "Bento Grid", color: "bg-blue-500" },
      { name: "Image Gallery", color: "bg-purple-500" },
      { name: "Image Trail", color: "bg-fuchsia-500" },
    ],
    features: [
      "8+ Professional Sections",
      "Full Next.js 15 Source Code",
      "Advanced Physics UI Components",
      "Optimized for SEO & Conversion",
      "100% Responsive & Theme-Ready",
      "Commercial License Included",
    ],
    demoPath: "/templates/zenblocks/app",
    checkoutUrl: "https://your-store.lemonsqueezy.com/checkout/buy/zenblocks",
    accent: "purple",
    screenshot: "/templates/zenblocks/zenblocks_preview.png",
  },
];

const COMING_SOON: ComingSoonItem[] = [
  { id: "T002", name: "Portfolio - Template ", codename: "Dev Portfolio", accent: "white" },
];
